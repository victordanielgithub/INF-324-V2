                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a target="_blank" href ="<?php echo base_url();?>reportes/reportepdf/pdf_listado_clientes"><i class="fa fa-circle-o"></i>Listado Clientes</a></li>
                            
                            <li><a target="_blank" href="<?php echo base_url();?>reportes/reportepdf/pdf_listado_productos"><i class="fa fa-circle-o"></i>Listado Productos</a></li>

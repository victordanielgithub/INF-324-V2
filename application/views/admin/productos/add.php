                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/productos/store" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="proveedor" id="proveedor" class="form-control">
                                    <?php foreach($proveedores as $proveedor):?>
                                        <option value="<?php echo $categoria->marca?>"><?php echo $proveedor->marca;?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="categoria" id="categoria" class="form-control">
                                    <?php foreach($categorias as $categoria):?>
                                        <option value="<?php echo $categoria->nombre?>"><?php echo $categoria->nombre."".$categoria->descripcion;?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group <?php echo !empty(form_error('precio_por_unidad')) ? 'has-error':'';?>">
                                <label for="precio_por_unidad">Precio Por Unidad:</label>
                                <input type="text" class="form-control" id="precio_por_unidad" name="precio_por_unidad" value="<?php echo set_value('precio_por_unidad');?>">

...
$(document).ready(function () {
    ...
    $dataproveedor = $proveedor->id_proveedor."*".$proveedor->marca."*".$proveedor->nombre_encargado."*".$proveedor->direccion."*".$proveedor->ciudad."*".$proveedor->telefono;
    $(".btn-view-proveedor").on("click", function(){
        var proveedor = $(this).val(); 
        //alert(cliente);
        var infoproveedor = proveedor.split("*");
        html = "<p><strong>Nombre:</strong>"+infoproveedor[1]+"</p>"
        html += "<p><strong>Tipo de Cliente:</strong>"+infoproveedor[2]+"</p>"
        html += "<p><strong>Tipo de Documento:</strong>"+infoproveedor[3]+"</p>"
        html += "<p><strong>Numero  de Documento:</strong>"+infoproveedor[4]+"</p>"
        html += "<p><strong>Telefono:</strong>"+infoproveedor[5]+"</p>"
        html += "<p><strong>Direccion:</strong>"+infoproveedor[6]+"</p>"
        $("#modal-default .modal-body").html(html);
    });
